    ...
    <>
      ...
      <div className="relative bg-gradient-to-r from-purple-500 to-blue-500 text-white p-10 rounded-lg shadow-lg max-w-4xl mx-auto mt-16">
        ...
        <p className="text-lg mt-6 text-center leading-relaxed">
          Hey there! 👋 I&apos;m a <strong>passionate writer, coder, and tech enthusiast</strong> who loves to explore and share knowledge.
          From <strong>technology trends</strong> to <strong>coding hacks</strong>, I bring insightful content that sparks curiosity and innovation. 🚀✨
        </p>
        ...
        <div className="mt-8 text-center">
          <Link href="/" className="inline-block bg-yellow-400 text-black font-semibold px-6 py-2 rounded-full shadow-lg hover:bg-yellow-500 transition">
            Read My Blogs →
          </Link>
        </div>
      </div>
